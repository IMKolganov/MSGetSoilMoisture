...
class Config:
    ...
    MQTTTOPIC_MSMICROCONTROLLERMANAGER_ESP32 = os.getenv('MQTTTOPIC_MSMICROCONTROLLERMANAGER_ESP32', 'control/soil-moisture/')
    MQTTTOPIC_ESP32_MSMICROCONTROLLERMANAGER = os.getenv('MQTTTOPIC_ESP32_MSMICROCONTROLLERMANAGER', 'status/soil-moisture/')
    ...
    QUEUES = [
        ...
        MQTTTOPIC_MSMICROCONTROLLERMANAGER_ESP32,
        MQTTTOPIC_ESP32_MSMICROCONTROLLERMANAGER
    ]
